...
describe('TodosController', () => {
    ...
    beforeEach(async () => {
        ...
        mockTodosService = {
            ...
            findById: (id: number) => Promise.resolve({ ...mockTodo, id: 1, isCompleted: false } as Todo),
            create: (todo: Partial<Todo>) => Promise.resolve({ ...mockTodo, id: 1, isCompleted: false } as Todo),
        }
